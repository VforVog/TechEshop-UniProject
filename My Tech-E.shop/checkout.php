...
if (mysqli_affected_rows($dbc) == 1) {
	...
	if ($affected == count($_SESSION['cart'])) { // Whohoo!
		...
		echo '<p  style="position: absolute; top: 42%; left:42%;">Thank you for your order. You will be notified when the items ship.</p>';
		...
		echo '<p style="position: absolute; top: 42%; left:25%;">Your order could not be processed due to a system error. You will be contacted in order to have the problem fixed. We apologize for the inconvenience.</p>';
